...
export default function HomeExpanded() {
  ...
  return <div className="app-shell">
    ...
    <aside className="app-sidebar">
      <div className="brand-block"><img src="/manus-storage/tt12-validator-logo_43635a60.png" alt="Biểu tượng TT12 Validator" className="brand-logo" /><div><p className="brand-name">TT12 <strong>Validator</strong></p><p className="brand-subline">DANH MỤC · EXCEL · BHYT</p></div></div>
